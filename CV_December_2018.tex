...
\begin{itemize}
	...
	\item {\large{\textit{The College of William \& Mary}}}
		\begin{itemize}\itemsep1pt \parskip2pt \parsep0pt
 	 		\item $\bullet$ Ph.D. Physics, expected January 2019.
 	 			\begin{itemize}
 	 				\item - \textit{Extraction and Parametrization of Isobaric Trinucleon Elastic Cross Sections
...
\begin{itemize} \itemsep5pt \parskip0pt \parsep0pt
  ...
  \item $\bullet$ \textbf{Jefferson Lab Run-A-Round:} First place in the men's 26-35 division run, May 2018. 
\end{itemize}
...
\begin{itemize}\itemsep5pt \parskip0pt \parsep0pt
  ...
  \item $\bullet$ \textbf{W$\&$M Climate Steering Committee:} Formed to assess social climate issues in the physics department and propose policy to resolve issues, College of William and Mary, 2015-present.
  	\begin{itemize}\itemsep2pt
